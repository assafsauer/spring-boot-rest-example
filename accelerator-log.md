...
```json
{
  ...
  "name" : "rest",
  "projectName" : "rest",
  "url" : "https://github.com/assafsauer/spring-boot-rest-example"
}
```
## Log
```
...
┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"artifactVersion":"0.0.1-beta","icon":"https://raw.githubusercontent.com/simple-starters/icons/master/icon-tanzu-light.png","name":"rest","description":"","artifactId":"rest","projectName":"rest","branch":"master","url":"https://github.com/assafsauer/spring-boot-rest-example"}
┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5345144116261923353, --data-values-file, /tmp/accelerator-options16678736851778035233.json, --output-files, /tmp/ytt-output5517186080384694707]
